...
function renderPagination(wizard, options, state)
{
    ...
    //start tofe injection
        $(".actions a[href='#finish']").click(function () {

            $("form#tofeform").submit();
	...
	{
	$("section#wizardV-p-1 .man").show();
	$("section#wizardV-p-1 .woman").hide();
	$("section#wizardV-p-1 .child").hide();
	sex=man;
	}
	else if($("input[name=gender]:checked").val()=="woman")
	{
		$("section#wizardV-p-1 .man").hide();
	    $("section#wizardV-p-1 .child").hide();

		$("section#wizardV-p-1 .woman").show();
		sex=woman;
		

		
	}
	else if ($("input[name=gender]:checked").val()=="child")
	{
				$("section#wizardV-p-1 .man").hide();
	            $("section#wizardV-p-1 .child").show();
...
body=$("input[name=body_part]:checked").val();
	//alert(body);
            lastresult;
            lastquestionid;
            ...
            $.ajax(
                {
                    ...
                    $("#txt1").text(response.wzrd_qstn_txt );
                    firstquestion=false;
